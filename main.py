...
if __name__ == '__main__':
    ...
    blockSize = myCrypto.getBlockSize("img.jpg")
    ...
    dataFileEncrypted = myCrypto.roundRobinEncrypt("img.jpg", key1, key2, key3, blockSize)
    keyFileEncrypted = myCrypto.getEncryptedKeysFile(masterKey, key1+key2+key3+blockSize.to_bytes(32,'big'))
